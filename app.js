// elm-watch hot {"version":"1.1.2","targetName":"My target name","webSocketPort":34345}
"use strict";
(() => {
...
var $author$project$Main$init = F3(
	function (_v0, _v1, key) {
		return _Utils_Tuple2(
			{key: key, mode: $author$project$Main$Waiting},
			$elm$core$Platform$Cmd$none);
	});
var $author$project$Main$AB = function (a) {
	return {$: 'AB', a: a};
};
var $author$project$Main$AwesomeBar = function (a) {
	return {$: 'AwesomeBar', a: a};
};
var $author$project$Main$Escape = {$: 'Escape'};
var $author$project$Main$ListenerRemoved = {$: 'ListenerRemoved'};
...
var $author$project$Main$SetString = F2(
	function (a, b) {
		return {$: 'SetString', a: a, b: b};
	});
var $author$project$Main$Disallow = {$: 'Disallow'};
var $author$project$Main$InsertText = function (a) {
	return {$: 'InsertText', a: a};
};
var $elm$core$Debug$log = _Debug_log;
var $author$project$Main$classifyInput = F2(
	function (inputType, data) {
		var _v0 = A2($elm$core$Debug$log, 'inputType', inputType);
		switch (_v0) {
			case 'insertText':
			...
			case 'insertCompositionText':
				return $author$project$Main$InsertText(0);
			case 'insertLink':
				return $author$project$Main$Disallow;
			...
			default:
				...
				return function (_v1) {
					...
					A2($elm$core$Debug$log, 'Invalid inputType seen', x));
		}
	});
var $elm$json$Json$Decode$map4 = _Json_map4;
var $author$project$Main$decodeInput = F2(
	function (model, state) {
		return A5(
			$elm$json$Json$Decode$map4,
			F4(
				function (inputType, data, start, end) {
					var _v0 = A2($author$project$Main$classifyInput, inputType, data);
					if (_v0.$ === 'Disallow') {
						return $author$project$Main$NoOp;
					} else {
						var added = _v0.a;
						var right = A2($elm$core$String$dropLeft, end, state.s);
						var left = A2($elm$core$String$left, start, state.s);
						return $author$project$Main$AB(
							A2(
								$author$project$Main$SetString,
								_Utils_ap(
									left,
...
var $author$project$Ports$sendEscape = _Platform_incomingPort(
	'sendEscape',
	$elm$json$Json$Decode$null(_Utils_Tuple0));
	...
	if (_v0.$ === 'Waiting') {
		return $elm$browser$Browser$Events$onKeyDown(
			A2(
				$elm$json$Json$Decode$map,
				function (key) {
					return (key === ' ') ? $author$project$Main$SwitchMode(
						$author$project$Main$AwesomeBar(
							{i: 0, s: ''})) : $author$project$Main$NoOp;
				},
				...
				[
					...
					A2(
						...
						$elm$json$Json$Decode$decodeValue(
							A2($author$project$Main$decodeInput, model, state)),
						$elm$core$Result$withDefault($author$project$Main$NoOp))),
					$author$project$Ports$listenerRemoved(
					function (_v1) {
						return $author$project$Main$AB($author$project$Main$ListenerRemoved);
					}),
					$author$project$Ports$sendEscape(
					function (_v2) {
						return $author$project$Main$AB($author$project$Main$Escape);
					})
				]));
	}
};
				...
				if (msg.a.$ === 'AwesomeBar') {
					...
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{
								mode: $author$project$Main$AwesomeBar(x)
							}),
					...
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{mode: $author$project$Main$Waiting}),
						$elm$core$Platform$Cmd$none);
				}
			default:
				var abmsg = msg.a;
						...
						default:
							...
							return _Utils_Tuple2(
								_Utils_update(
									model,
									{
										mode: $author$project$Main$AwesomeBar(
											_Utils_update(
												x,
												{i: i, s: s}))
									}),
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										$elm$html$Html$text(
										A2($elm$core$Debug$log, 'Generating TEXT node', state.s))
									]))
							]));
				}
			}()
...
_Platform_export({'Main':{'init':$author$project$Main$main(
	$elm$json$Json$Decode$succeed(_Utils_Tuple0))({"versions":{"elm":"0.19.1"},"types":{"message":"Main.Msg","aliases":{"Main.AwesomeBarState":{"args":[],"type":"{ s : String.String, i : Basics.Int }"}},"unions":{"Main.Msg":{"args":[],"tags":{"NoOp":[],"SwitchMode":["Main.Mode"],"AB":["Main.ABMsg"]}},"Main.ABMsg":{"args":[],"tags":{"SetString":["String.String","Basics.Int"],"ListenerRemoved":[],"Escape":[]}},"Main.Mode":{"args":[],"tags":{"Waiting":[],"AwesomeBar":["Main.AwesomeBarState"]}},"Basics.Int":{"args":[],"tags":{"Int":[]}},"String.String":{"args":[],"tags":{"String":[]}}}}})}});}(this));