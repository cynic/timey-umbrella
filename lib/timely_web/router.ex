defmodule TimelyWeb.Router do
  ...
  import TimelyWeb.UserAuth

  pipeline :browser do
    plug :accepts, ["html"]
    plug :fetch_session
    plug :fetch_live_flash
    plug :put_root_layout, html: {TimelyWeb.Layouts, :root}
  ...
  scope "/", TimelyWeb do
    ...
    live_session :redirect_if_user_is_authenticated,
      on_mount: [{TimelyWeb.UserAuth, :redirect_if_user_is_authenticated}] do
  ...
  scope "/", TimelyWeb do
    ...
    live_session :current_user,
      on_mount: [{TimelyWeb.UserAuth, :mount_current_user}] do
