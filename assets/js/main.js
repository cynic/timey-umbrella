(() => {
  ...
  // elm:/home/cynic/Projects/timely/assets/frontend/src/Main.elm
  var require_Main = __commonJS({
    "elm:/home/cynic/Projects/timely/assets/frontend/src/Main.elm"(exports) {
      (function(scope) {
        "use strict";
        ...
        var _String_slice = F3(function(start2, end2, str) {
        ...
        function _String_toInt(str) {
          ...
          var start2 = code0 == 43 || code0 == 45 ? 1 : 0;
          for (var i = start2; i < str.length; ++i) {
          ...
          return i == start2 ? $elm$core$Maybe$Nothing : $elm$core$Maybe$Just(code0 == 45 ? -total : total);
        }
        ...
        var $elm$core$Array$fetchNewTail = F4(
          function(shift, end2, treeEnd, tree) {
            fetchNewTail:
              while (true) {
                ...
                if (_v0.$ === "SubTree") {
                  var sub = _v0.a;
                  var $temp$shift = shift - $elm$core$Array$shiftStep, $temp$end = end2, $temp$treeEnd = treeEnd, $temp$tree = sub;
                  shift = $temp$shift;
                  end2 = $temp$end;
                  ...
                  var values = _v0.a;
                  return A3($elm$core$Elm$JsArray$slice, 0, $elm$core$Array$bitMask & end2, values);
                }
              }
          }
        );
            ...
            if (_Utils_eq(end2, len)) {
              ...
              if (_Utils_cmp(
                ...
                return A4(
                  ...
                  startShift,
                  tree,
                  A3($elm$core$Elm$JsArray$slice, 0, $elm$core$Array$bitMask & end2, tail)
                );
              } else {
                var endIdx = $elm$core$Array$tailIndex(end2);
                var depth = $elm$core$Basics$floor(
                  A2(
                ...
                return A4(
                  ...
                  A4($elm$core$Array$fetchNewTail, startShift, end2, endIdx, tree)
                );
              }
            }
          }
        ...
        var $author$project$Data$Tick = function(a) {
          return { $: "Tick", a };
        };
        var $author$project$Data$Waiting = { $: "Waiting" };
        ...
        var $author$project$Data$AwesomeBar = function(a) {
          return { $: "AwesomeBar", a };
        };
        var $author$project$Data$CaretMoved = function(a) {
          return { $: "CaretMoved", a };
        };
        ...
        var $author$project$Ports$awesomeBarInput = _Platform_incomingPort("awesomeBarInput", $elm$json$Json$Decode$value);
        var $elm$core$Platform$Sub$batch = _Platform_batch;
        var $author$project$Ports$caretMoved = _Platform_incomingPort("caretMoved", $elm$json$Json$Decode$value);
        var $author$project$Data$SetString = F2(
          function(a, b) {
            return { $: "SetString", a, b };
          }
        );
        var $author$project$Main$DeleteBackwards = { $: "DeleteBackwards" };
        var $author$project$Main$DeleteForwards = { $: "DeleteForwards" };
        var $author$project$Main$Disallow = { $: "Disallow" };
        var $author$project$Main$InsertText = { $: "InsertText" };
        var $elm$core$Debug$log = _Debug_log;
        var $author$project$Main$classifyInput = F2(
          function(inputType, data) {
            switch (inputType) {
              case "insertText":
                return $author$project$Main$InsertText;
              case "insertReplacementText":
                return $author$project$Main$InsertText;
              case "insertFromPaste":
                return $author$project$Main$InsertText;
              case "deleteByCut":
                return $author$project$Main$DeleteBackwards;
              case "deleteContent":
                return $author$project$Main$DeleteBackwards;
              case "deleteContentBackward":
                return $author$project$Main$DeleteBackwards;
              case "deleteContentForward":
                return $author$project$Main$DeleteForwards;
              case "insertCompositionText":
                return $author$project$Main$InsertText;
              default:
                var x = inputType;
                return function(_v1) {
                  return $author$project$Main$Disallow;
                }(
                  A2($elm$core$Debug$log, "Unhandled inputType seen", x)
                );
            }
          }
        );
        ...
        var $author$project$Main$decodeInput = function(model) {
          var _v0 = model.mode;
          if (_v0.$ === "Waiting") {
            return $elm$json$Json$Decode$fail("Not in awesomebar mode");
          } else {
            var state = _v0.a;
            return A5(
              $elm$json$Json$Decode$map4,
              F4(
                function(inputType, data, start2, end2) {
                  var _v1 = A2($author$project$Main$classifyInput, inputType, data);
                  switch (_v1.$) {
                    case "Disallow":
                      return $author$project$Data$NoOp;
                    case "InsertText":
                      var right = A2($elm$core$String$dropLeft, end2, state.s);
                      var left = A2($elm$core$String$left, start2, state.s);
                      var added = $elm$core$String$length(data);
                      return $author$project$Data$AB(
                        A2(
                          $author$project$Data$SetString,
                          _Utils_ap(
                            left,
                            _Utils_ap(data, right)
                          ),
                          start2 + added
                        )
                      );
                    case "DeleteBackwards":
                      return !start2 && _Utils_eq(end2, start2) ? $author$project$Data$NoOp : _Utils_eq(start2, end2) ? $author$project$Data$AB(
                        A2(
                          $author$project$Data$SetString,
                          _Utils_ap(
                            A2($elm$core$String$left, start2 - 1, state.s),
                            A2($elm$core$String$dropLeft, end2, state.s)
                          ),
                          start2 - 1
                        )
                      ) : $author$project$Data$AB(
                        A2(
                          $author$project$Data$SetString,
                          _Utils_ap(
                            A2($elm$core$String$left, start2, state.s),
                            A2($elm$core$String$dropLeft, end2, state.s)
                          ),
                          start2
                        )
                    ...
                    default:
                      return _Utils_eq(start2, end2) ? $author$project$Data$AB(
                        A2(
                          $author$project$Data$SetString,
                          _Utils_ap(
                            A2($elm$core$String$left, start2, state.s),
                            A2($elm$core$String$dropLeft, end2 + 1, state.s)
                          ),
                          start2
                        )
                      ) : $author$project$Data$AB(
        ...
        var $author$project$Data$Enter = { $: "Enter" };
        var $author$project$Data$Escape = { $: "Escape" };
        var $author$project$Data$Key = function(a) {
          return { $: "Key", a };
        };
        var $author$project$Data$Tab = { $: "Tab" };
        var $author$project$Main$decodeSpecialKey = function(key) {
          switch (key) {
            case "Escape":
              return $author$project$Data$AB(
                $author$project$Data$Key($author$project$Data$Escape)
              );
            case "Tab":
              return $author$project$Data$AB(
                $author$project$Data$Key($author$project$Data$Tab)
              );
            case "Enter":
              return $author$project$Data$AB(
                $author$project$Data$Key($author$project$Data$Enter)
              );
            default:
              return $author$project$Data$NoOp;
          }
        ...
        var $author$project$Ports$listenerRemoved = _Platform_incomingPort(
          "listenerRemoved",
        ...
        var $author$project$Ports$sendSpecial = _Platform_incomingPort("sendSpecial", $elm$json$Json$Decode$string);
        ...
        var $author$project$Main$subscriptions = function(model) {
          ...
          if (_v0.$ === "Waiting") {
                ...
                [
                  $elm$browser$Browser$Events$onKeyDown(
                    A2(
                      $elm$json$Json$Decode$map,
                      function(key) {
                        return key === " " ? $author$project$Data$SwitchMode(
                          $author$project$Data$AwesomeBar(
                            { i: 0, parse: _List_Nil, s: "" }
                          )
                        ) : $author$project$Data$NoOp;
                      },
                      A2($elm$json$Json$Decode$field, "key", $elm$json$Json$Decode$string)
                    )
                  ),
                  A2($elm$time$Time$every, 6e4, $author$project$Data$Tick)
                ]
              )
            );
          } else {
            ...
            return $elm$core$Platform$Sub$batch(
              _List_fromArray(
                [
                  $author$project$Ports$awesomeBarInput(
                    A2(
                      $elm$core$Basics$composeR,
                      $elm$json$Json$Decode$decodeValue(
                        $author$project$Main$decodeInput(model)
                      ),
                      $elm$core$Result$withDefault($author$project$Data$NoOp)
                    )
                  ),
                  $author$project$Ports$listenerRemoved(
                    function(_v1) {
                      return $author$project$Data$AB($author$project$Data$ListenerRemoved);
                    }
                  ),
                  $author$project$Ports$sendSpecial($author$project$Main$decodeSpecialKey),
                  $author$project$Ports$caretMoved(
                    function(input) {
                      return A2(
                        ...
                        A2(
                          $elm$core$Result$map,
                          function(i) {
                            return _Utils_eq(i, state.i) ? $author$project$Data$NoOp : $author$project$Data$AB(
                              $author$project$Data$CaretMoved(i)
                            );
                          },
                          A2(
                            $elm$json$Json$Decode$decodeValue,
        ...
        var $author$project$Ports$displayAwesomeBar = _Platform_outgoingPort(
          "displayAwesomeBar",
          function($) {
            return $elm$json$Json$Encode$null;
          }
        );
        var $author$project$Main$smallDurationToMinutes = function(d) {
          if (d.$ === "Minutes") {
            var m = d.a;
            return m;
          } else {
        ...
        var $author$project$Main$findMaxDuration = function(list) {
          return A3(
            $elm$core$List$foldl,
            F2(
              function(item, state) {
                if (item.a.$ === "Duration") {
                  ...
                  if (state.$ === "Nothing") {
                    ...
                    return $elm$core$Maybe$Just(
                      _Utils_cmp(
                        $author$project$Main$smallDurationToMinutes(d_),
                        $author$project$Main$smallDurationToMinutes(d)
                      ) > 0 ? d_ : d
                    );
                  }
                } else {
        ...
        var $author$project$Ports$hideAwesomeBar = _Platform_outgoingPort(
          "hideAwesomeBar",
          function($) {
            return $elm$json$Json$Encode$null;
          }
        );
        var $author$project$View$isWithinOffset = F3(
          function(offset, extent, caretPosition2) {
            return _Utils_cmp(offset, caretPosition2) < 1 && _Utils_cmp(offset + extent, caretPosition2) > -1;
          }
        );
        ...
        var $author$project$Data$Date = F4(
        ...
        var $author$project$View$posixToDate = F2(
          function(zone, nowish) {
            return A4(
              $author$project$Data$Date,
              A2($elm$time$Time$toYear, zone, nowish),
              A2($elm$time$Time$toMonth, zone, nowish),
              A2($elm$time$Time$toDay, zone, nowish),
              A2($elm$time$Time$toWeekday, zone, nowish)
            );
          }
        );
        var $author$project$Data$Description = { $: "Description" };
        var $author$project$Main$findFirst = F2(
          function(list, data) {
            findFirst:
              while (true) {
                if (!list.b) {
                  ...
                  var _v1 = f(data);
                  if (_v1.$ === "Nothing") {
                    var $temp$list = tail, $temp$data = data;
                    list = $temp$list;
                    data = $temp$data;
                    continue findFirst;
                  } else {
        ...
        var $author$project$Data$Duration = function(a) {
          return { $: "Duration", a };
        };
        ...
        var $author$project$Parsers$intParser = function(_v0) {
          var min = _v0.a;
          var max = _v0.b;
          return A2(
              ...
              return A2(
                ...
                function(value) {
                  return A2(
                    $elm$parser$Parser$andThen,
                    function(ofs1) {
                      return _Utils_cmp(ofs1, ofs0) > 0 ? A2(
                        $elm$core$Maybe$withDefault,
                        $elm$parser$Parser$problem("Expected an integer, got " + value),
                        A2(
                          $elm$core$Maybe$map,
                          function(v) {
                            ...
                            if (_v1.a.$ === "Just") {
                              if (_v1.b.$ === "Just") {
                                var min_ = _v1.a.a;
                                var max_ = _v1.b.a;
                                return _Utils_cmp(v, min_) > -1 && _Utils_cmp(v, max_) < 1 ? $elm$parser$Parser$succeed(v) : $elm$parser$Parser$problem(
                                  "Expected an integer between " + ($elm$core$String$fromInt(min_) + (" and " + ($elm$core$String$fromInt(max_) + (", inclusive; got " + value))))
                                );
                              } else {
                                var min_ = _v1.a.a;
                                var _v2 = _v1.b;
                                return _Utils_cmp(v, min_) > -1 ? $elm$parser$Parser$succeed(v) : $elm$parser$Parser$problem(
                                  "Expected an integer greater than or equal to " + ($elm$core$String$fromInt(min_) + ("; got " + value))
                                );
                              }
                            } else {
                              if (_v1.b.$ === "Just") {
                                var _v3 = _v1.a;
                                var max_ = _v1.b.a;
                                return _Utils_cmp(v, max_) < 1 ? $elm$parser$Parser$succeed(v) : $elm$parser$Parser$problem(
                                  "Expected an integer less than or equal to " + ($elm$core$String$fromInt(max_) + ("; got " + value))
                                );
                              } else {
                                var _v4 = _v1.a;
                                var _v5 = _v1.b;
                                return $elm$parser$Parser$succeed(v);
                              }
                            }
                          },
                          $elm$core$String$toInt(value)
                        )
                      ) : $elm$parser$Parser$problem("Expected an integer, but got a blank");
                    },
        ...
        var $author$project$Data$Hours = F2(
          function(a, b) {
            return { $: "Hours", a, b };
          }
        );
        ...
        var $author$project$Parsers$x_dot_y_hParser = function(initial) {
          return A2(
            $elm$parser$Parser$andThen,
            function(_final) {
                  ...
                  [
                    A2(
                      ...
                      $elm$parser$Parser$succeed(
                        _Utils_Tuple2(
                          A2($author$project$Data$Hours, initial, _final),
              ...
              $elm$parser$Parser$oneOf(
                _List_fromArray(
                  [
                    A2(
                      $elm$parser$Parser$ignorer,
                      $elm$parser$Parser$succeed(30),
                      $elm$parser$Parser$symbol("5")
                    ),
                    A2(
                      $elm$parser$Parser$ignorer,
                      $elm$parser$Parser$succeed(15),
                      $elm$parser$Parser$symbol("25")
                    ),
                    A2(
                      $elm$parser$Parser$ignorer,
                      $elm$parser$Parser$succeed(45),
                      $elm$parser$Parser$symbol("75")
                    )
                  ]
                )
              )
        ...
        var $author$project$Parsers$x_fraction_hParser = function(initial) {
          return A2(
            $elm$parser$Parser$andThen,
            function(_final) {
              return $elm$parser$Parser$oneOf(
                ...
                _List_fromArray(
                  [
                    A2(
                      $elm$parser$Parser$ignorer,
                      $elm$parser$Parser$succeed(30),
                      $elm$parser$Parser$symbol("\xBD")
                    ),
                    A2(
                      $elm$parser$Parser$ignorer,
                      $elm$parser$Parser$succeed(15),
                      $elm$parser$Parser$symbol("\xBC")
                    ),
                    A2(
                      $elm$parser$Parser$ignorer,
                      $elm$parser$Parser$succeed(20),
                      $elm$parser$Parser$symbol("\u2153")
                    ),
                    A2(
                      $elm$parser$Parser$ignorer,
                      $elm$parser$Parser$succeed(40),
                      $elm$parser$Parser$symbol("\u2154")
                    ),
                    A2(
                      $elm$parser$Parser$ignorer,
                      $elm$parser$Parser$succeed(45),
                      $elm$parser$Parser$symbol("\xBE")
                    )
                  ]
                )
              )
        ...
        var $author$project$Data$Minutes = function(a) {
          return { $: "Minutes", a };
        };
        var $author$project$Parsers$x_hmParser = function(initial) {
          return A2(
            $elm$parser$Parser$keeper,
            $elm$parser$Parser$succeed($elm$core$Basics$identity),
            $elm$parser$Parser$oneOf(
              _List_fromArray(
                [
                  A2(
                    $elm$parser$Parser$andThen,
                    function(_v0) {
                      return initial >= 5 ? $elm$parser$Parser$succeed(
                        _Utils_Tuple2(
                          $author$project$Data$Minutes(initial),
                          $elm$core$Maybe$Just("m")
                        )
                      ) : $elm$parser$Parser$succeed(
                        _Utils_Tuple2(
                          A2($author$project$Data$Hours, initial, 0),
                          $elm$core$Maybe$Just("h")
                        )
                      );
                    },
        ...
        var $author$project$Parsers$shortDurationParser = A2(
          $elm$parser$Parser$map,
          function(_v0) {
            var t = _v0.a;
            var c = _v0.b;
            return _Utils_Tuple2(
              $author$project$Data$Duration(t),
              c
            );
          },
          A2(
            ...
            function(initial) {
              return $elm$parser$Parser$oneOf(
                _List_fromArray(
                  [
                    $author$project$Parsers$x_hmParser(initial),
                    $author$project$Parsers$x_fraction_hParser(initial),
                    $author$project$Parsers$x_dot_y_hParser(initial)
                  ]
                )
              );
            },
            A2(
              ...
              $author$project$Parsers$intParser(
                _Utils_Tuple2(
        ...
        var $author$project$Main$isDuration = function(list) {
          return A2(
              ...
              return A2(
                ...
                A2(
                  ...
                  function(_v0) {
                    ...
                    return $elm$core$Maybe$Just(
                      _Utils_Tuple3(token, completion, 1)
                    );
                  },
                  A2($elm$parser$Parser$run, $author$project$Parsers$shortDurationParser, s)
                )
              );
            },
        ...
        var $author$project$Data$Today = { $: "Today" };
        var $author$project$Main$isToday = function(list) {
              ...
              if (_v0.$ === "Just") {
                switch (_v0.a) {
                  case "tod":
                    return $elm$core$Maybe$Just(
                      _Utils_Tuple3(
                        $author$project$Data$Today,
                        $elm$core$Maybe$Just("ay"),
                        1
                      )
                    );
                  case "toda":
                  ...
                  case "today":
                    return $elm$core$Maybe$Just(
                      _Utils_Tuple3($author$project$Data$Today, $elm$core$Maybe$Nothing, 1)
                    );
                  default:
                    break _v0$3;
                }
        ...
        var $author$project$Data$Tomorrow = { $: "Tomorrow" };
        var $author$project$Main$isTomorrow = function(list) {
          var _v0 = $elm$core$List$head(list);
          _v0$6:
            while (true) {
              if (_v0.$ === "Just") {
                switch (_v0.a) {
                  case "tom":
                    return $elm$core$Maybe$Just(
                      _Utils_Tuple3(
                        $author$project$Data$Tomorrow,
                        $elm$core$Maybe$Just("orrow"),
                        1
                      )
                    );
                  case "tomo":
                  ...
                  case "tomorrow":
                    return $elm$core$Maybe$Just(
                      _Utils_Tuple3($author$project$Data$Tomorrow, $elm$core$Maybe$Nothing, 1)
                    );
                  default:
                    break _v0$6;
                }
        ...
        var $author$project$Main$parse = F3(
          function(offsets, s, acc) {
            var strings = A2(
              $elm$core$List$map,
              function(_v4) {
                var offset = _v4.offset;
                var extent = _v4.extent;
                return A3($elm$core$String$slice, offset, offset + extent, s);
              },
              offsets
            );
            if (!offsets.b) {
              ...
              return A2(
                  ...
                  if (tail.b) {
                    ...
                    return A3(
                      ...
                      A2(
                        $elm$core$List$cons,
                        _Utils_Tuple3(
                          $author$project$Data$Description,
                          $elm$core$Maybe$Nothing,
                          _Utils_update(
                            h,
                            { extent: h2.offset - h.offset }
                          )
                        ),
                        acc
                      )
                    ...
                    return A3(
                      ...
                      A2(
                        $elm$core$List$cons,
                        _Utils_Tuple3($author$project$Data$Description, $elm$core$Maybe$Nothing, h),
                        acc
                      )
                    );
                  }
                ...
                A2(
                  ...
                  function(_v1) {
                    ...
                    var combinedOffset = {
                      extent: A2(
                        ...
                        A2(
                          $elm$core$Maybe$map,
                          function(last) {
                            return last.offset + last.extent - h.offset;
                          },
                          $elm$core$List$head(
                            A2($elm$core$List$drop, n - 1, offsets)
                          )
                        )
                      ),
                      offset: h.offset
                    ...
                    var newAcc = A2(
                      $elm$core$List$cons,
                      _Utils_Tuple3(token, completion, combinedOffset),
                      acc
                    );
                    if (tail.b) {
                      var h2 = tail.a;
                      return A3(
                        $author$project$Main$parse,
                        A2($elm$core$List$drop, n, offsets),
                        s,
                        A2(
                          $elm$core$List$cons,
                          _Utils_Tuple3(
                            $author$project$Data$Description,
                            $elm$core$Maybe$Nothing,
                            { extent: h2.offset - (h.offset + h.extent), offset: h.offset + h.extent }
                          ),
                          newAcc
                        )
                      );
                  ...
                  A2(
                    $author$project$Main$findFirst,
                    _List_fromArray(
                      [$author$project$Main$isToday, $author$project$Main$isTomorrow, $author$project$Main$isDuration]
                    ),
                    strings
                  )
                )
        ...
        var $author$project$Ports$shiftCaret = _Platform_outgoingPort("shiftCaret", $elm$json$Json$Encode$int);
        var $author$project$Main$tokenise = F4(
          function(s, i, current, acc) {
            tokenise:
              while (true) {
                var _v0 = _Utils_Tuple2(
                ...
                if (_v0.b.$ === "Nothing") {
                  switch (_v0.a) {
                    ...
                    case " ":
                      var _v2 = _v0.b;
                      var $temp$s = s, $temp$i = i + 1, $temp$current = $elm$core$Maybe$Nothing, $temp$acc = acc;
                      s = $temp$s;
                      i = $temp$i;
                    ...
                    default:
                      var _v3 = _v0.b;
                      var $temp$s = s, $temp$i = i + 1, $temp$current = $elm$core$Maybe$Just(
                        { extent: 1, offset: i }
                      ), $temp$acc = acc;
                      s = $temp$s;
                      i = $temp$i;
                  ...
                  switch (_v0.a) {
                    ...
                    case " ":
                      var c = _v0.b.a;
                      var $temp$s = s, $temp$i = i + 1, $temp$current = $elm$core$Maybe$Nothing, $temp$acc = A2($elm$core$List$cons, c, acc);
                      s = $temp$s;
                      i = $temp$i;
                      current = $temp$current;
                      acc = $temp$acc;
        ...
        var $author$project$Main$updateSetString = F4(
          function(s, i, x, model) {
            return _Utils_Tuple2(
              _Utils_update(
                model,
                {
                  mode: $author$project$Data$AwesomeBar(
                    _Utils_update(
                      x,
                      {
                        i,
                        parse: A3(
                          $author$project$Main$parse,
                          A4($author$project$Main$tokenise, s, 0, $elm$core$Maybe$Nothing, _List_Nil),
                          s,
                          _List_Nil
                        ),
                        s
              ...
              $author$project$Ports$shiftCaret(i)
            );
          }
        );
                ...
                if (msg.a.$ === "AwesomeBar") {
                  ...
                  return _Utils_Tuple2(
                    _Utils_update(
                      model,
                      {
                        mode: $author$project$Data$AwesomeBar(x)
                      }
                    ),
                    $author$project$Ports$displayAwesomeBar(_Utils_Tuple0)
                  );
                } else {
                  var _v1 = msg.a;
                  return _Utils_Tuple2(
                ...
                if (_v2.$ === "AwesomeBar") {
                  ...
                  switch (abmsg.$) {
                    ...
                    case "Key":
                      switch (abmsg.a.$) {
                        case "Escape":
                          ...
                          return _Utils_Tuple2(
                            model,
                            $author$project$Ports$hideAwesomeBar(_Utils_Tuple0)
                          );
                        case "Tab":
                          var _v5 = abmsg.a;
                          return A2(
                            ...
                            A2(
                              $elm$core$Maybe$map,
                              function(_v7) {
                                var completion = _v7.a;
                                var offset = _v7.b.offset;
                                var extent = _v7.b.extent;
                                var s2 = _Utils_ap(
                                  A2($elm$core$String$left, offset + extent, x.s),
                                  _Utils_ap(
                                    completion,
                                    A2($elm$core$String$dropLeft, offset + extent, x.s)
                                  )
                                );
                                var i2 = offset + extent + $elm$core$String$length(completion);
                                return A4($author$project$Main$updateSetString, s2, i2, x, model);
                              },
                              $elm$core$List$head(
                                A2(
                                  $elm$core$List$filterMap,
                                  function(_v6) {
                                    var completion = _v6.b;
                                    var ofs = _v6.c;
                                    var offset = ofs.offset;
                                    var extent = ofs.extent;
                                    return A2(
                                      $elm$core$Maybe$andThen,
                                      function(completion_) {
                                        return A3($author$project$View$isWithinOffset, offset, extent, x.i) ? $elm$core$Maybe$Just(
                                          _Utils_Tuple2(completion_, ofs)
                                        ) : $elm$core$Maybe$Nothing;
                                      },
                                      completion
                                    );
                            ...
                            _Utils_update(
                              model,
                              {
                                data: A2(
                                  $elm$core$List$cons,
                                  {
                                    created: A2($author$project$View$posixToDate, model.zone, model.nowish),
                                    duration: $author$project$Main$findMaxDuration(x.parse),
                                    s: x.s
                                  },
                                  model.data
                                ),
                    ...
                    default:
                      var s = abmsg.a;
                      var i = abmsg.b;
                      return A4($author$project$Main$updateSetString, s, i, x, model);
                  }
                } else {
                  return _Utils_Tuple2(model, $elm$core$Platform$Cmd$none);
                }
        ...
        var $author$project$View$classFor = function(token) {
          switch (token.$) {
            case "Today":
              return "when";
            case "Tomorrow":
        ...
        var $author$project$View$tokenWithCompletion = F4(
          function(s, token, completion, txt) {
            return A2(
              $elm$html$Html$span,
              _List_fromArray(
                [
                  $elm$html$Html$Attributes$classList(
                    _List_fromArray(
                      [
                        _Utils_Tuple2(
                          "token-viz",
                          !_Utils_eq(token, $author$project$Data$Description)
                        ),
                        _Utils_Tuple2(
                          $author$project$View$classFor(token),
                          !_Utils_eq(token, $author$project$Data$Description)
                        )
                      ]
                    )
                  ...
                  A2(
                    ...
                    $elm$core$String$fromInt(
                      $elm$core$String$length(completion)
                    )
                  )
                ]
              ),
                  ...
                  A2(
                    ...
                    _List_fromArray(
                      [
                        ...
                        $elm$html$Html$Attributes$contenteditable(false),
                        A2($elm$html$Html$Attributes$attribute, "inert", "true"),
                        A2($elm$html$Html$Attributes$attribute, "data-completion", completion)
                      ]
                    ),
                    _List_fromArray(
                      [
                        $elm$html$Html$text(completion)
                      ]
                    )
                  )
                ]
        ...
        var $author$project$View$tokenWithoutCompletion = F3(
          function(s, token, txt) {
            return A2(
              $elm$html$Html$span,
              _List_fromArray(
                [
        ...
        var $author$project$View$tokenToView = F3(
          function(s, caretPosition2, _v0) {
            var token = _v0.a;
            var completion = _v0.b;
            var offset = _v0.c.offset;
            var extent = _v0.c.extent;
            var txt = A3($elm$core$String$slice, offset, offset + extent, s);
            var _v1 = _Utils_Tuple2(
              completion,
              A3($author$project$View$isWithinOffset, offset, extent, caretPosition2)
            );
            if (_v1.a.$ === "Nothing") {
              var _v2 = _v1.a;
              return A3($author$project$View$tokenWithoutCompletion, s, token, txt);
            } else {
              if (!_v1.b) {
                return A3($author$project$View$tokenWithoutCompletion, s, token, txt);
              } else {
                var completion_ = _v1.a.a;
                return A4($author$project$View$tokenWithCompletion, s, token, completion_, txt);
              }
            }
          }
        );
        var $author$project$View$viewAwesomeBar = F2(
              ...
              _List_fromArray(
                [
                  A3(
                    ...
                    _List_fromArray(
                      [
                        $elm$html$Html$Attributes$id("awesomebar-container")
                      ]
                    ),
                    _List_fromArray(
                      [
                        _Utils_Tuple2(
                          ...
                          A2(
                            ...
                            _List_fromArray(
                              [
                                $elm$html$Html$Attributes$id("awesomebar-title")
                              ]
                            ),
                            _List_fromArray(
                              [
                          ...
                          A2(
                            ...
                            _List_fromArray(
                              [
                                ...
                                $elm$html$Html$Attributes$id("awesomebar")
                              ]
                            ),
                            function() {
                              var tokenHtml = A2(
                                $elm$core$List$map,
                                A2($author$project$View$tokenToView, state.s, state.i),
                                state.parse
                              );
                              var last = $elm$core$List$head(
                                A2(
                                  $elm$core$List$drop,
                                  $elm$core$List$length(state.parse) - 1,
                                  state.parse
                                )
                              );
                              var suffix = A2(
                                $elm$core$Maybe$map,
                                function(_v6) {
                                  var offset = _v6.c.offset;
                                  var extent = _v6.c.extent;
                                  return $elm$html$Html$text(
                                    A2(
                                      $elm$core$String$repeat,
                                      $elm$core$String$length(state.s) - (offset + extent),
                                      " "
                                    )
                                  );
                                },
                              ...
                              var first = $elm$core$List$head(state.parse);
                              var prefix = A2(
                                $elm$core$Maybe$map,
                                function(_v5) {
                                  var offset = _v5.c.offset;
                                  return $elm$html$Html$text(
                              ...
                              var _v0 = _Utils_Tuple2(prefix, suffix);
                              if (_v0.a.$ === "Nothing") {
                                if (_v0.b.$ === "Nothing") {
                                  var _v1 = _v0.a;
                                  var _v2 = _v0.b;
                                ...
                                if (_v0.b.$ === "Nothing") {
                                  var prefixHtml = _v0.a.a;
                                  var _v3 = _v0.b;
                                  return A2($elm$core$List$cons, prefixHtml, tokenHtml);
                                } else {
                                  var prefixHtml = _v0.a.a;
                                  var suffixHtml = _v0.b.a;
                                  return _Utils_ap(
                                    A2($elm$core$List$cons, prefixHtml, tokenHtml),
                                    _List_fromArray(
                                      [suffixHtml]
                                    )
                                  );
        ...
        var $justinmimbs$time_extra$Time$Extra$Parts = F7(
          function(year, month, day, hour, minute, second, millisecond) {
            return { day, hour, millisecond, minute, month, second, year };
          }
        );
        ...
        var $justinmimbs$time_extra$Time$Extra$timeFromClock = F4(
          function(hour, minute, second, millisecond) {
            return hour * 36e5 + minute * 6e4 + second * 1e3 + millisecond;
          }
        );
        ...
        var $justinmimbs$time_extra$Time$Extra$toOffset = F2(
          function(zone, posix) {
            ...
            return (localMillis - millis) / 6e4 | 0;
          }
        );
        var $justinmimbs$time_extra$Time$Extra$posixFromDateTime = F3(
          function(zone, date, time) {
            ...
            var posix1 = $elm$time$Time$millisToPosix(millis - offset0 * 6e4);
            var offset1 = A2($justinmimbs$time_extra$Time$Extra$toOffset, zone, posix1);
            if (_Utils_eq(offset0, offset1)) {
              return posix1;
            } else {
              var posix2 = $elm$time$Time$millisToPosix(millis - offset1 * 6e4);
        ...
        var $author$project$View$addWeeks = F2(
          function(weeks, date) {
            return A2(
              ...
              function(posix) {
                return $elm$time$Time$millisToPosix(
                  $elm$time$Time$posixToMillis(posix) + weeks * 7 * 864e5 + 1e5
                );
              }(
                A2(
        ...
        var $author$project$View$cmpDate = F2(
          function(date1, date2) {
            var posix2 = $elm$time$Time$posixToMillis(
              A2(
                $justinmimbs$time_extra$Time$Extra$partsToPosix,
                $elm$time$Time$utc,
                A7($justinmimbs$time_extra$Time$Extra$Parts, date2.year, date2.month, date2.day, 0, 0, 0, 0)
              )
            );
            var posix1 = $elm$time$Time$posixToMillis(
              A2(
                $justinmimbs$time_extra$Time$Extra$partsToPosix,
                $elm$time$Time$utc,
                A7($justinmimbs$time_extra$Time$Extra$Parts, date1.year, date1.month, date1.day, 0, 0, 0, 0)
              )
            );
        ...
        var $author$project$View$decrementDay = function(date) {
          return A2(
            ...
            function(posix) {
              return $elm$time$Time$millisToPosix(
                $elm$time$Time$posixToMillis(posix) - 863e5
              );
            }(
              A2(
                $justinmimbs$time_extra$Time$Extra$partsToPosix,
        ...
        var $author$project$View$incrementDay = function(date) {
          return A2(
            ...
            function(posix) {
              return $elm$time$Time$millisToPosix(
                $elm$time$Time$posixToMillis(posix) + 865e5
              );
            }(
              A2(
                $justinmimbs$time_extra$Time$Extra$partsToPosix,
        ...
        var $author$project$View$monthToString = function(month) {
          switch (month.$) {
            case "Jan":
              return "January";
            case "Feb":
            ...
            return A2(
              ...
              A2(
                ...
                A2(
                  ...
                  _List_fromArray(
                    [
                      $elm$html$Html$Attributes$class("calendar-week")
                    ]
                  ),
                  A2(
                    $elm$core$List$map,
                    function(dayname) {
                      return A2(
                        ...
                        _List_fromArray(
                          [
                            $elm$html$Html$Attributes$class("calendar-dayname")
                          ]
                        ),
                        _List_fromArray(
                          [
                      ...
                      A2(
                        ...
                        function(day) {
                          ...
                          return A2(
                            ...
                            _List_fromArray(
                              [
                                $elm$html$Html$Attributes$class("calendar-day"),
                                $elm$html$Html$Attributes$classList(
                                  _List_fromArray(
                                    [
                                      _Utils_Tuple2(
                                        "today",
                                        _Utils_eq(cmp, $elm$core$Basics$EQ)
                                      ),
                                      _Utils_Tuple2(
                                        "past",
                                        _Utils_eq(cmp, $elm$core$Basics$LT)
                                      ),
                                      _Utils_Tuple2("month-start", day.day === 1),
                                      _Utils_Tuple2(
                                        "weekend",
                                        _Utils_eq(day.weekday, $elm$time$Time$Sat) || _Utils_eq(day.weekday, $elm$time$Time$Sun)
                                      ),
                                      _Utils_Tuple2(
                                        "highlight",
                                        highlight(day)
                        ...
                        A3(
                          ...
                          F2(
                            function(_v0, state) {
                              return $author$project$View$incrementDay(state);
                            }
                          ),
                          A2($author$project$View$addWeeks, weekNo, saturday),
                          A2($elm$core$List$range, 1, 6)
                        )
                      )
                    );
                  },
                  A2($elm$core$List$range, 0, numWeeks - 1)
                )
              )
            );
          }
        ...
        var $author$project$View$viewTodoList = function(model) {
          return A2(
            $elm$html$Html$ol,
            _List_Nil,
            A2(
                  ...
                  _List_fromArray(
                    [
                      ...
                      A2(
                        ...
                        _List_fromArray(
                          [
                            $elm$html$Html$Attributes$class("todo-created")
                          ]
                        ),
                        _List_fromArray(
                          [
                            $elm$html$Html$text(
                              "Created " + ($elm$core$String$fromInt(created.year) + ("-" + ($author$project$View$monthToString(created.month) + ("-" + $elm$core$String$fromInt(created.day)))))
                            )
                          ]
                        )
                      ),
                        ...
                        if (duration.$ === "Nothing") {
                          ...
                          return A2(
                            ...
                            _List_fromArray(
                              [
                                function() {
                                  if (duration_.$ === "Minutes") {
                                    var m = duration_.a;
                                    if (m === 1) {
                                      return $elm$html$Html$text("1 minute");
                                    } else {
                                      if (m < 60) {
                                        return $elm$html$Html$text(
                                          $elm$core$String$fromInt(m) + " minutes"
                                        );
                                      } else {
                                        var h = A2($elm$core$Basics$modBy, 60, m);
                                        var min = m - h * 60;
                                        return !min ? $elm$html$Html$text(
                                          $elm$core$String$fromInt(h) + "h"
                                        ) : $elm$html$Html$text(
                                          $elm$core$String$fromInt(h) + ("h" + ($elm$core$String$fromInt(min) + "m"))
                                        );
                                      }
                                    }
                                  } else {
                                    if (!duration_.b) {
                                      ...
                                      var m = duration_.b;
                                      return $elm$html$Html$text(
                                        $elm$core$String$fromInt(h) + ("h" + ($elm$core$String$fromInt(m) + "m"))
                                      );
                                    }
                                  }
                                }()
            ...
            _List_fromArray(
              [
                function() {
                  var _v0 = model.mode;
                  if (_v0.$ === "Waiting") {
                    return $author$project$View$viewTodoList(model);
                  } else {
                    var state = _v0.a;
                    return A2(
                      $elm$html$Html$div,
                      ...
                      _List_fromArray(
                        [
                          A2($author$project$View$viewAwesomeBar, model, state),
                          $author$project$View$viewTodoList(model),
                          A3(
        ...
        )({ "versions": { "elm": "0.19.1" }, "types": { "message": "Data.Msg", "aliases": { "Data.AwesomeBarState": { "args": [], "type": "{ s : String.String, i : Basics.Int, parse : List.List ( Data.Token, Maybe.Maybe String.String, Data.Offset ) }" }, "Time.Era": { "args": [], "type": "{ start : Basics.Int, offset : Basics.Int }" }, "Data.Offset": { "args": [], "type": "{ offset : Basics.Int, extent : Basics.Int }" } }, "unions": { "Data.Msg": { "args": [], "tags": { "NoOp": [], "SwitchMode": ["Data.Mode"], "AB": ["Data.ABMsg"], "Tick": ["Time.Posix"], "GetZone": ["Time.Zone"] } }, "Data.ABMsg": { "args": [], "tags": { "SetString": ["String.String", "Basics.Int"], "ListenerRemoved": [], "Key": ["Data.ABSpecialKey"], "CaretMoved": ["Basics.Int"] } }, "Data.Mode": { "args": [], "tags": { "Waiting": [], "AwesomeBar": ["Data.AwesomeBarState"] } }, "Time.Posix": { "args": [], "tags": { "Posix": ["Basics.Int"] } }, "Time.Zone": { "args": [], "tags": { "Zone": ["Basics.Int", "List.List Time.Era"] } }, "Data.ABSpecialKey": { "args": [], "tags": { "Escape": [], "Tab": [], "Enter": [], "ArrowDown": [], "ArrowUp": [] } }, "Basics.Int": { "args": [], "tags": { "Int": [] } }, "List.List": { "args": ["a"], "tags": {} }, "Maybe.Maybe": { "args": ["a"], "tags": { "Just": ["a"], "Nothing": [] } }, "String.String": { "args": [], "tags": { "String": [] } }, "Data.Token": { "args": [], "tags": { "Today": [], "Tomorrow": [], "Description": [], "Duration": ["Data.SmallDuration"] } }, "Data.SmallDuration": { "args": [], "tags": { "Minutes": ["Basics.Int"], "Hours": ["Basics.Int", "Basics.Int"] } } } } }) } });
      })(exports);
    }
  });
  ...
  var caretChangingKeys = /* @__PURE__ */ new Set([
    "ArrowLeft",
    "ArrowRight",
    "ArrowUp",
    "ArrowDown",
      ...
      if (range.isCollapsed === true) {
        ...
        if (e.key === "ArrowRight") {
          ...
          if (ofs === 0 && node.nodeType === Node.TEXT_NODE && node.textContent.length > 0 && node.textContent.trim() === "") {
            ...
            if (prev && prev.nodeType === Node.ELEMENT_NODE && prev.tagName === "SPAN" && prev.dataset.completionlen !== void 0) {
  ...
  function userTextLength() {
    ...
    for (var current = bar.firstChild; current; current = current.nextSibling) {
      ...
      if (current.nodeType === Node.ELEMENT_NODE && current.dataset.completionlen !== void 0) {
  ...
  function getCaretPosition(selection, getNode, getOffset) {
    ...
    console.log(`ERROR in getCaretPosition?? I don't know what to do with this node\u{1F447}`);
    console.log(node);
    return null;
  }
  function getCaretPositions() {
    if (document.activeElement.id !== "awesomebar") {
      console.log("Active element is NOT the awesomebar, it is \u{1F447}");
  ...
  function beforeInputListener(event) {
    ...
    if (event.inputType === "insertReplacementText") {
      ...
      let packaged = {
        inputType: event.inputType,
        data: event.inputType === "insertFromPaste" ? event.dataTransfer.getData("text") : event.data ?? "",
        start,
        end
      };
      app.ports.awesomeBarInput.send(packaged);
  ...
  var observation = (mutationList, _observer) => {
