defmodule Timey.Router do
  use Timey, :router

  import Timey.UserAuth

  pipeline :browser do
    plug :accepts, ["html"]
    plug :fetch_session
    plug :fetch_live_flash
    plug :put_root_layout, html: {Timey.Layouts, :root}
  ...
  if Application.compile_env(:timey, :dev_routes) do
    ...
    scope "/dev" do
      ...
      live_dashboard "/dashboard", metrics: Timey.Telemetry
  ...
  scope "/", Timey do
    ...
    live_session :redirect_if_user_is_authenticated,
      on_mount: [{Timey.UserAuth, :redirect_if_user_is_authenticated}] do
  ...
  scope "/", Timey do
    ...
    live_session :require_authenticated_user,
      on_mount: [{Timey.UserAuth, :ensure_authenticated}] do
  ...
  scope "/", Timey do
    ...
    live_session :current_user,
      on_mount: [{Timey.UserAuth, :mount_current_user}] do
...
#     else
#       id = IdPrefixApp.PrefixGenerator.get_id()
